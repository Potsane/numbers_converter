...
object Constants {
    ...
    const val SHARE_APP_BODY =
        "\n Hi there, I am using this amazing app. If you want to convert a number into binary, decimal, octal or hexadecimal system, you can install it from here.\n" +
                "\n App link is:https://play.google.com/store/apps/details?id=online.whatsuptonight"
}